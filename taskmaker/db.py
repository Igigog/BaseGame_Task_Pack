...
icons = {
    "bs_assault_monster_online": "ui_iconsTotal_mutant",
    "bs_assault_stalker_online": "ui_inGame2_PD_Lider",
...
quests = {
    "bs_fetch_patches": [
        ...
        {"Haron"},
        {"Griffin"},
        {"Trader", "Mercenary", "Zaton"},
    ],
    "bs_assault_monster_online": [
        {"Barman"},
        {"Hunter"},
    ],
    "bs_assault_stalker_online": [
        {"Olivius"},
        {"Kuznetsov"},
        {"Petrenko"},
    ],
    "bs_kill_stalker_nearby": [
        {"Barkeep"},
        {"Olivius"},
        {"Trapper"},
        {"Kuznetsov"},
